void main(){
  ...
  --------------------------------------------------------------------------------------------
  Tambien tendremos acceso a algunos metodos que permitan la transformacion o filtrado 
  del contenido
  Por ejemplo usar reversed, para invertir el orden original: ${numeros.reversed}
  Es importante observar que la funcion reversed ha transformado la LIST original y la
  ...
  //Un SET es una estructura de datos utilizada por DART, que simplifica los elementos eliminado los duplicados
  ...
  print("Elimnados duplicados ... ${numerosMayoresA5.toSet()}");
